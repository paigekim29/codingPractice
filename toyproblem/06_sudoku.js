...
function sudoku(board) {
  ...
  // once number cannot be inserted, it will go to if statement and put 0 back again
  // and then step back to previous recursion with board and put next available number
